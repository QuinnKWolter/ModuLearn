...
def process_launch_data(request, launch_data):
    ...
    if instance_id:
        try:
            ...
            logger.info("Canvas launch context: course_id=%s assignment_id=%s", canvas_course_id, canvas_assignment_id)
            ...
            if canvas_course_id and canvas_assignment_id:
                ...
                logger.info("Stored LTI outcome service URL for instance %s", course_instance.id)
