...
urlpatterns = [
    ...
    path('<str:course_instance_id>/generate-anonymous-students/', views.generate_anonymous_students, name='generate_anonymous_students'),
    ...
    path('instance/<int:instance_id>/instructors/<int:user_id>/remove/', views.remove_course_instructor, name='remove_course_instructor'),
