...
urlpatterns = [
    ...
    path('studies/<int:study_id>/analytics/', views.study_analytics_dashboard, name='study_analytics_dashboard'),
    path('studies/<int:study_id>/analytics/export.csv', views.export_study_analytics_csv, name='export_study_analytics_csv'),
