...
def parse_computed_model(model_string: str, is_topics: bool = True, resource_names: List[str] = None) -> Dict[str, Any]:
    ...
    When present after k/p, the next fields are treated as attempt count,
    success rate, and a comma-preserved attempt trajectory.
    ...
    Returns:
        ...
        For content: Dict structure: {content_name: {k, p, a, s, aSeq}}
    """
    if not model_string:
        return {}
    ...
    try:
        ...
        for learner_id in learner_ids:
            ...
            learners.append({
                ...
                'isHidden': False,
                'lastActive': progress_data.get('last_update'),
                'state': state
            })
...
def get_student_progress_from_db(learner_id: str, course_id: int, resource_names: List[str] = None) -> Optional[Dict[str, Any]]:
    """
